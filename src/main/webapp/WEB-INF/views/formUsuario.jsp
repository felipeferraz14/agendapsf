			...
			<legend>Cadastro de Usuário</legend>
				<form:form servletRelativeAction="/agendapsf/usuario" method="POST">
					...
					<div class="contato">
						...
						<input type="text" name="telefone" placeholder="73 3291-9092">
					</div>	
					<div class="contato">
						<label>Celular</label>
						<input type="text" name="celular" placeholder="73 999998888">
					</div>	
					<div>
						<label>Posto de Saúde</label>
						<select name="postosaude.id" class="form-control">
					...
					<div>
						<label>Senha</label>
						<input type="text" name="senha" class="form-control" id="password">
					</div>
